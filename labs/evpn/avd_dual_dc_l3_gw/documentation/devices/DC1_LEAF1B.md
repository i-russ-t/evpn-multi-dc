...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.249.0 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC1_LEAF1A_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC1_LEAF1A_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_dc1-server01_Eth2 | *trunk | *110 | *- | *- | 5 |
| Ethernet6 | SERVER_dc1-server02_Eth2 | *trunk | *111 | *- | *- | 6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC1_SPINE1_Ethernet2 | - | 172.31.100.5/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC1_SPINE2_Ethernet2 | - | 172.31.100.7/31 | default | 9214 | False | - | - |
...
interface Ethernet2
   ...
   mtu 9214
   no switchport
   ip address 172.31.100.7/31
!
interface Ethernet3
   description MLAG_DC1_LEAF1A_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_DC1_LEAF1A_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description SERVER_dc1-server01_Eth2
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_dc1-server02_Eth2
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC1_LEAF1A_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_DC1_LEAF1A_Port-Channel3
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.100.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.101.3/32 |
| Loopback10 | DIAG_VRF_RED | RED | 10.255.10.4/32 |
| Loopback20 | DIAG_VRF_BLUE | BLUE | 10.255.20.4/32 |
...
| 172.31.100.4 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.100.6 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.100.4:10110 | 10110:10110 | - | - | learned |
| 111 | 192.168.100.4:10111 | 10111:10111 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.4:20 | connected |
| RED | 192.168.100.4:10 | connected |
...
router bgp 65101
   ...
   neighbor 10.255.250.0 description DC1_LEAF1A_Vlan4093
   neighbor 172.31.100.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.4 remote-as 65100
   neighbor 172.31.100.4 description DC1_SPINE1_Ethernet2
   neighbor 172.31.100.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.6 remote-as 65100
   neighbor 172.31.100.6 description DC1_SPINE2_Ethernet2
   ...
   !
   vlan 110
      rd 192.168.100.4:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 111
      rd 192.168.100.4:10111
