...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAVES | Vlan4094 | 10.255.249.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC1_BORDER_LEAF1_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC1_BORDER_LEAF1_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC1_SPINE1_Ethernet6 | - | 172.31.100.21/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC1_SPINE2_Ethernet6 | - | 172.31.100.23/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_WAN_Ethernet2 | - | 172.31.250.2/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC1_BORDER_LEAF1_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.100.8/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.101.7/32 |
| Loopback10 | DIAG_VRF_RED | RED | 10.255.10.8/32 |
| Loopback20 | DIAG_VRF_BLUE | BLUE | 10.255.20.8/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  10.255.250.9/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.249.9/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.250.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.31.100.20 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.100.22 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.250.3 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.8:20 | connected |
| RED | 192.168.100.8:10 | connected |
