...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC2_LEAF2B_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC2_LEAF2B_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_dc2-server03_Eth1 | *trunk | *122 | *- | *- | 5 |
| Ethernet6 | SERVER_dc2-server04_Eth1 | *trunk | *123 | *- | *- | 6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC2_SPINE1_Ethernet3 | - | 172.31.200.9/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC2_SPINE2_Ethernet3 | - | 172.31.200.11/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC2_LEAF2B_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.200.5/32 |
...
| 172.31.200.8 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.200.10 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 122 | 192.168.200.5:10122 | 10122:10122 | - | - | learned |
| 123 | 192.168.200.5:10123 | 10123:10123 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.200.5:20 | connected |
| RED | 192.168.200.5:10 | connected |
...
router bgp 65202
   ...
   neighbor 10.255.252.5 description DC2_LEAF2B_Vlan4093
   neighbor 172.31.200.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.200.8 remote-as 65200
   neighbor 172.31.200.8 description DC2_SPINE1_Ethernet3
   neighbor 172.31.200.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.200.10 remote-as 65200
   neighbor 172.31.200.10 description DC2_SPINE2_Ethernet3
