...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.249.1 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC1_LEAF1B_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC1_LEAF1B_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_dc1-server01_Eth1 | *trunk | *110 | *- | *- | 5 |
| Ethernet6 | SERVER_dc1-server02_Eth1 | *trunk | *111 | *- | *- | 6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC1_SPINE1_Ethernet1 | - | 172.31.100.1/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC1_SPINE2_Ethernet1 | - | 172.31.100.3/31 | default | 9214 | False | - | - |
...
interface Ethernet2
   ...
   mtu 9214
   no switchport
   ip address 172.31.100.3/31
!
interface Ethernet3
   description MLAG_DC1_LEAF1B_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_DC1_LEAF1B_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description SERVER_dc1-server01_Eth1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_dc1-server02_Eth1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC1_LEAF1B_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
| Port-Channel5 | PortChannel5 | trunk | 110 | - | - | - | - | 5 | - |
| Port-Channel6 | PortChannel6 | trunk | 111 | - | - | - | - | 6 | - |
...
interface Port-Channel3
   description MLAG_DC1_LEAF1B_Port-Channel3
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.100.3/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.101.3/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.250.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.31.100.0 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.100.2 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.255.250.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.250.1 description DC1_LEAF1B_Vlan4093
   neighbor 172.31.100.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.0 remote-as 65100
   neighbor 172.31.100.0 description DC1_SPINE1_Ethernet1
   neighbor 172.31.100.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.2 remote-as 65100
   neighbor 172.31.100.2 description DC1_SPINE2_Ethernet1
