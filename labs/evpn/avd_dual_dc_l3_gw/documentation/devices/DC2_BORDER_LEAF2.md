...
| --------- | --------------- | ------------ | --------- |
| DC2_BORDER_LEAVES | Vlan4094 | 10.255.251.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC2_BORDER_LEAF1_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC2_BORDER_LEAF1_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC2_SPINE1_Ethernet6 | - | 172.31.200.21/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC2_SPINE2_Ethernet6 | - | 172.31.200.23/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_WAN_Ethernet4 | - | 172.31.250.6/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_DC2_SPINE1_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_DC2_SPINE2_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description MLAG_DC2_BORDER_LEAF1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_DC2_BORDER_LEAF1_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description P2P_WAN_Ethernet4
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC2_BORDER_LEAF1_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_DC2_BORDER_LEAF1_Port-Channel3
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.200.8/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  10.255.252.9/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.251.9/31  |  -  |  -  |  -  |  -  |
...
router bgp 65203
   ...
   neighbor 10.255.252.8 description DC2_BORDER_LEAF1_Vlan4093
