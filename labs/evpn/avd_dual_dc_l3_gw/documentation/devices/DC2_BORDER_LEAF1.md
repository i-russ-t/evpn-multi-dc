...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.23/24 | 172.100.100.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_BORDER_LEAVES | Vlan4094 | 10.255.251.9 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC2_BORDER_LEAF2_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC2_BORDER_LEAF2_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC2_SPINE1_Ethernet5 | - | 172.31.200.17/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC2_SPINE2_Ethernet5 | - | 172.31.200.19/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_WAN_Ethernet3 | - | 172.31.250.4/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC2_BORDER_LEAF2_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.200.7/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.202.7/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  10.255.252.8/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.251.8/31  |  -  |  -  |  -  |  -  |
...
| 172.31.250.5 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65203
   ...
   neighbor 10.255.252.9 description DC2_BORDER_LEAF2_Vlan4093
   neighbor 172.31.200.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.200.16 remote-as 65200
   neighbor 172.31.200.16 description DC2_SPINE1_Ethernet5
   neighbor 172.31.200.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.200.18 remote-as 65200
   neighbor 172.31.200.18 description DC2_SPINE2_Ethernet5
   neighbor 172.31.250.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.250.5 remote-as 65300
   neighbor 172.31.250.5 description WAN_Ethernet3
