...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAVES | Vlan4094 | 10.255.249.9 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DC1_BORDER_LEAF2_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DC1_BORDER_LEAF2_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC1_SPINE1_Ethernet5 | - | 172.31.100.17/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC1_SPINE2_Ethernet5 | - | 172.31.100.19/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_WAN_Ethernet1 | - | 172.31.250.0/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_DC1_SPINE1_Ethernet5
   no shutdown
   mtu 9214
   no switchport
   ip address 172.31.100.17/31
!
interface Ethernet2
   description P2P_DC1_SPINE2_Ethernet5
   no shutdown
   mtu 9214
   no switchport
   ip address 172.31.100.19/31
!
interface Ethernet3
   description MLAG_DC1_BORDER_LEAF2_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_DC1_BORDER_LEAF2_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DC1_BORDER_LEAF2_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_DC1_BORDER_LEAF2_Port-Channel3
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.100.7/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.101.7/32 |
| Loopback10 | DIAG_VRF_RED | RED | 10.255.10.7/32 |
| Loopback20 | DIAG_VRF_BLUE | BLUE | 10.255.20.7/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  10.255.250.8/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.249.8/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.250.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.31.100.16 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.100.18 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.250.1 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 192.168.200.8 | 65203 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
router bgp 65103
   ...
   neighbor 10.255.250.9 description DC1_BORDER_LEAF2_Vlan4093
   neighbor 172.31.100.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.16 remote-as 65100
   neighbor 172.31.100.16 description DC1_SPINE1_Ethernet5
   neighbor 172.31.100.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.18 remote-as 65100
   neighbor 172.31.100.18 description DC1_SPINE2_Ethernet5
   neighbor 172.31.250.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.250.1 remote-as 65300
   neighbor 172.31.250.1 description WAN_Ethernet1
